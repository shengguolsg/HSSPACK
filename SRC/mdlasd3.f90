    SUBROUTINE MDLASD3(NL, NR, SQRE, K, D, Q, LDQ, DSIGMA, U, LDU, U2, &
...
!  =======
!
!  MDLASD3 finds all the square roots of the roots of the secular
...
!         left singular vectors, and the first K columns contain the non-deflated
...
!  ===============
!
!  The same as dlasd3 of LAPACK routine. 
!  Modify some interpretations of variables, on Jan. 20th, 2013.
!   1) U and VT are the left and right singular vector matrices, respectively.
!      U2 and VT2 are intermediate variable, used to computed U and VT. 
!
!  =====================================================================
!
!     .. Parameters ..
