...
!  =======
!
!  MDLASD32 finds the square roots of the roots of the secular equation,
!  as defined by the values in DSIGMA and Z. It makes the appropriate
!  calls to DLASD4.
!
!  MDLASD32 is called from the routine of computing both left and right
!  svecs of a broken arrow matrix.
!
!  Arguments
!  =========
!
