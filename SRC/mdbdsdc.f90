      SUBROUTINE MDBDSDC(UPLO, COMPQ, N, D, E, U, LDU, VT, LDVT, Q, IQ, & 
                         WORK, IWORK, INFO )
!
...
!  =======
!
!  MDBDSDC computes the singular value decomposition (SVD) of a real
!  N-by-N (upper or lower) bidiagonal matrix B:  B = U * S * VT,
!  using a divide and conquer method, where S is a diagonal matrix
!  with non-negative diagonal elements (the singular values of B), and
!  U and VT are orthogonal matrices of left and right singular vectors,
!  respectively. MDBDSDC can be used to compute all singular values,
!  and optionally, singular vectors or singular vectors in compact form.
!
!  This code is evovled from LAPACK routines and makes the same assumptions
!  about floating point arithmetic as LAPACK routines. This code uses structured
!  matrix techniques to compute the singular vectors, which makes the algorithm 
!  need much less workspace. 
!
...
!  Further Details
!  ===============
!  Based on LAPACK routine, DBDSDC
!  Written by S.-G. Li, in Changsha, Dec. 29st, 2012
!  =====================================================================
!
!     .. Parameters ..
...
!     .. External Subroutines ..
      EXTERNAL           DCOPY, DLARTG, DLASCL, MDLASD0, DLASDA, DLASDQ, &
...
!
            ...
            END IF
            IF( ICOMPQ.EQ.2 ) THEN
               CALL MDLASD0( NSIZE, SQRE, D( START ), E( START ), &
