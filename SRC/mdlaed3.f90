...
!
! Q2 stores the eigenvector matrix to be updated, and after it is updated, its
! entries will be copied to Q. 
!
!  Arguments:
!  ==========
!
...
!
!  =====================================================================
      SUBROUTINE MDLAED3( K,N,D,Q,LDQ,RHO,DLAMDA,Q2,Z,DIFL,DIFR,ALPHA,WORK, &
           INFO)
!
      USE CauchyHssEig
      IMPLICIT NONE
...
!     ..
!     .. Local Scalars ..
      INTEGER            I, II, IQ2, J, N12, N2, N23, Ni
...
!
      Ni  = 200    ! block size for nodes at the bottom level
      CALL DHSSEVC( K,Ni,DLAMDA,D,Z,ALPHA,DIFL,DIFR,Q2,N,INFO )
