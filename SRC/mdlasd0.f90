      SUBROUTINE MDLASD0(N, SQRE, D, E, U, LDU, VT, LDVT, SMLSIZ, IWORK, &
                         WORK, INFO )
!
...
!  Further Details
!  ===============
!   Based on LAPACK routine dlasd0
!   Written by S.-G. Li, NUDT, Dec. 29th, 2012
!  =====================================================================
!
!     .. Local Scalars ..
...
!     .. External Subroutines ..
      EXTERNAL           MDLASD1, DLASDQ, DLASDT, XERBLA
!     ..
...
!
      ...
      CALL DLASDT( N, NLVL, ND, IWORK( INODE ), IWORK( NDIML ), &
                   IWORK( NDIMR ), SMLSIZ )
!
!!$      write(*,*) 'The row numbers of left children', IWORK(NDIML:NDIML+ND-1)
!!$      write(*,*) 'The row numbers of right children', IWORK(NDIMR:NDIMR+ND-1)
!!$      write(*,*) 'The size of bottom problem', SMLSIZ
!
...
!
         ...
         DO 40 I = LF, LL
            ...
            ALPHA = D( IC )
            BETA = E( IC )
            CALL MDLASD1( NL, NR, SQREI, D( NLF ), ALPHA, BETA, &
